...
<!DOCTYPE html>
<title>HASIL KONSULTASI | SISPAK VANAME</title>
<html lang="en">
...
<body background="assets/bg.png">
    <div class="container"><br>
                ...
                <div class="col-sm-6">
                    <table class="table table-striped table-hover table-bordered" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $key => $value) {
                                //Rumus MD
                                $hasil = (@$temp_md) + ($value["md"] * (1 - (@$temp_md)));
                            ?>
                                <tr>
                                    <td>MD<?= $iteration ?></td>
                                    <td><?= number_format($hasil, 3) ?></td>
        ...
        <div class="badan" style="text-align: center;">
            <?php
            $penyakit = ucwords(ucfirst($_GET["penyakit"] === "tsv" ? "taura syndrome virus" : str_replace("_", " ", $_GET["penyakit"])));
            $query = "SELECT * FROM daftar_penyakit WHERE nama_penyakit='{$penyakit}'";
            ...
            <table class="table table-striped table-hover table-bordered text-left" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <b><?= $cfPencent = number_format($valueMB - $valueMD, 2) * 100 ?>%</b>
                        </td>
                    </tr>
                    <tr>
                        <th>Solusi</th>
                        <td>
                            <?= $cfPencent ? $penyakit["solusi"] : "Tidak ada" ?>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <h5>
                <a href=" ./m_konsultasi3.php?choose_skip=bintik_putih" class="btn btn-primary">
