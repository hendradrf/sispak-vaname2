...
<html lang="en">
<head>
  <title>BERANDA | SISPAK SKRIPSI</title>
  <meta charset="utf-8">
             ...
             <br><br>
               <div class="play-btn">
                  <div class="play-btn-inner">
                    <a href="m_konsultasi3.php?choose_skip=bintik_putih">
                      <i class="fa fa-play" style="color: #42455a; padding-top: 16px; padding-left: 15px;"></i>
                    </a>
                  </div>                  <small><b><a style="text-decoration: none; color: #42455a;" href="m_konsultasi3.php?choose_skip=bintik_putih">Mulai Konsultasi</a></b></small>
