...
<head>
  <title>KONSULTASI | SISPAK SKRIPSI</title>
  <meta charset="utf-8">
...
<body background="assets/bg.png">
  ...
  <div class="container"></br>
                ...
                <div class="tab pertanyaan" id="pertanyaan-<?= $data[0] ?>">
                  <div class="row">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="custom-control-button tidak-class custom-control custom-radio custom-control-inline" id="data_tidak">
                        <input type="hidden" value="<?= $data[2] ?>" id="data_skip">
                        <?php if($_GET['choose_skip']=='insang_merah'){ ?>
                        <input type="hidden" value="insang_merah" id="insang_merah">
                       <?php }else{ ?>
                        <input type="hidden" value="bukan" id="insang_merah">
                       <?php } ?>
    ...
    <script>
      ...
      document.getElementById('data_tidak').onclick = reply_click;     
      ...
      function next(id_current) {
        ...
        const id_next = questions[questionIndex + 1];
         ...
         var number=document.getElementById("data_skip").value;
         var insang_merah=document.getElementById("insang_merah").value;
         console.log(number);
         console.log(insang_merah);

         console.log(this.pertanyaan);

         if(this.pertanyaan=='tidak'){
           if(number=='g002'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=bintik_hitam";
           }
           if(number=='g004'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=kotoran_putih";
           }
           if(number=='g007'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=insang_merah";
           }
           if(number=='g001' && insang_merah=='insang_merah'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=nekrosis";
           }
           if(number=='g005'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=udang_gripis";
           }
           if(number=='g012'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=kepala_kuning";
           }
           if(number=='g014'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=tsv";
           }
             if(number=='g014'){
            window.location.href = "http://localhost/sispak-vaname2/m_konsultasi3.php?choose_skip=tsv";
           }
